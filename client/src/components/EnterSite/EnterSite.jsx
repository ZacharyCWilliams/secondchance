      ...
      <div className={this.state.mode ? "App light-mode" : "App dark-mode"}>
        <div className="enter-site-holder">
          <div className="enter-site-container">
            <div>
              <div>
                <h1 className="enter-site-nav">Second Chance</h1>
              </div>
              <div className="button-container">
                <div className="light-toggle"></div>
                <div className="dark-toggle"></div>
                <button className="toggle-button" className={this.state.mode ? "button-light-m" : "button-dark-m"} onClick={this.mode}>{this.state.buttonText}</button>
              </div>
            </div>
            <div className="flex-container-enter-site">
              <div className="flex-box-enter">
                <div className="enter-site-flex">
                  {/* <div> */}
                    <h1 className="enter-site-h1">Staying Connected Matters</h1>
                  {/* </div> */}
                  <p className="enter-site-p">Second Chance is a platform aimed at improving our justice system. We're driving down the recidivism rate by keeping inmates and their loved ones connected during their time apart.</p>
                    {/* <button 
